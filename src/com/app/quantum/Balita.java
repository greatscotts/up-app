...
public class Balita extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    Button q = (Button) findViewById(R.id.button2);
	     q.setOnClickListener(new View.OnClickListener() {
	        ...
	        Intent i = new Intent(Balita.this,Info.class);
	        startActivity(i);
	        finish();
	        } 
	     });
	     ...
	     b.setOnClickListener(new View.OnClickListener() {
	        public void onClick(View arg0) {
	        Intent i = new Intent(Balita.this,Misc.class);
	        startActivity(i);
	        finish();
	        } 
	     });
	     ...
	     g.setOnClickListener(new View.OnClickListener() {
	        public void onClick(View arg0) {
	        Intent i = new Intent(Balita.this,Social.class);
	        startActivity(i);
	        finish();
	        } 
	     });
	     ...
	     z.setOnClickListener(new View.OnClickListener() {
	        public void onClick(View arg0) {
	        Intent i = new Intent(Balita.this,Logon.class);
	        startActivity(i);
	        finish();
	        } 
	     });
		...
		ourBrow.loadUrl("http://www.upd.edu.ph/~updinfo/In%20the%20news/index.html");
        ...
        webView.loadUrl("http://www.upd.edu.ph/~updinfo/In%20the%20news/index.html");
    }
